#!/usr/bin/python3
"""Este módulo define un rectángulo completo.
Ahora también se despide cuando se borra la instancia.
"""


class Rectangle:
    """Clase que representa un rectángulo.
    Calcula área, perímetro, se puede imprimir y hasta se despide.
    """
    ...
    def __del__(self):
        """Mensaje que se imprime cuando se elimina una instancia."""
        print("Bye rectangle...")
