#!/usr/bin/python3
"""Este módulo define un rectángulo con funciones completas,
incluyendo crear cuadrados desde la misma clase.
"""


class Rectangle:
    """Clase que representa un rectángulo.
    Se puede imprimir, comparar, contar, crear cuadrados y más.
    """
    ...
    def square(cls, size=0):
        """Crea un nuevo rectángulo cuadrado (ancho = alto = size)."""
